...
class HtagController extends AdminController
{
    ...
    public function index(string $lang, Request $request)
    {
        ...
        return view('admin.modules.htag.index', [
            'settings' => Htag::query()->paginate(10)
        ]);
...
//    }
    ...
    {
        return view('admin.modules.htag.update', [
            'setting' => Htag::query()->find($id)
        ]);
    ...
    public function update(string $locale, Request $request, int $id)
    {
        ...
        Htag::query()->where('id',$id)
            ->update(['value' => $request->post('value')]);




        return redirect(route('hTagIndex', $locale))->with('success', __('admin.setting_success_update'));
